...
public record CustomOrderResponse(
        ...
        String flowerShippingCarrier,
        String flowerShippingTrackingCode,
        String receivedFlowerImageUrl,
        FlowerEvaluationStatus receivedFlowerEvaluationStatus,
        String receivedFlowerEvaluationNote,
